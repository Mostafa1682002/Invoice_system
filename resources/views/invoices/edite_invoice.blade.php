                    ...
                    <form action="{{ route('invoices.update', ['invoice' => $id]) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col col-12 col-sm-12 col-md-6 col-lg-4 mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    onchange="myFunction()"
                                    value="@php echo $invoice->discount>0 ? $invoice->discount : 0; @endphp" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="notes" rows="3">{{ $invoice->notes }}</textarea>
                            </div>
                        </div><br>
