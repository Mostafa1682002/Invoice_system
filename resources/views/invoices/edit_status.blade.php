...
@section('content')
    ...
    <div class="row">
        <div class="col-12 my-3">
            @if ($errors->any())
                <div class="alert alert-danger" role="alert">
                    ...
                    لم يتم انشاء الفاتوره برجاء التاكد من البيانات
                </div>
            @endif
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoices.update_status', ['id' => $invoice->id]) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col col-12 col-sm-12 col-md-6 col-lg-4 mb-3">
                                <label for="SectiontName" class="control-label">القسم</label>
                                <select name="section_id" id="SectiontName" class="form-control SlectBox">
                                    <!--placeholder-->
                        ...
                        <div class="row">
                            ...
                            <div class="col col-12 col-sm-12 col-md-6 col-lg-4 mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount" name="discount"
                                    title="يرجي ادخال مبلغ الخصم " value="{{ $invoice->discount }}" required readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="notes" rows="3" readonly>{{ $invoice->notes }}</textarea>
                            </div>
                        </div><br>
                        <div class="row mb-3">
                            <div class="col col-12 col-sm-12 col-md-6 mb-3">
                                <label for="value_status" class="control-label">حالة الدفع</label>
                                <select name="value_status" id="value_status" class="form-control SlectBox" required>
                                    <!--placeholder-->
