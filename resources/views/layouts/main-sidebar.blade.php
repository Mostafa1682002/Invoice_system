        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('invoices.paid') }}">الفواتيرالمدفوعه</a></li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('invoices.unpaid') }}">الفواتيرالغير مدفوعه</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('invoices.partial') }}">الفواتيرالمدفوعه جزئيا</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
            ...
            @can('التقارير')
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ route('customer_reports') }}">تقاريرالعملاء</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة المستخدمين')
                            <li><a class="slide-item" href="{{ route('users.index') }}">قائمةالمستخدمين</a></li>
                        @endcan
                        @can('صلاحيات المستخدمين')
                            <li><a class="slide-item" href="{{ route('roles.index') }}">صلاحيةالمستخدمين</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'widgets')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">تواصل معنا</span></a>
            </li>
        </ul>
    </div>
</aside>
