    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                ...
                <p class="mg-b-0">مشروع انشاء وتسجيل الفواتير</p>
            </div>
        </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{ $number_invoices }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">{{ $pre_allinvoice }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ $number_unpaidinvoices }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">{{ $pre_unpaidinvoice }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ $sum_total_sempaidinvoice }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ $number_sempaidinvoices }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">{{ $pre_sempaidinvoice }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ $number_paidinvoices }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">{{ $pre_paidinvoice }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
